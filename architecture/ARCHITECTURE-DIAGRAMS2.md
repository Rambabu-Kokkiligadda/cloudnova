...
graph TB
    subgraph "Client Layer - Browser"
        Web["🌐 React Web App<br/>Material-UI 5<br/>TypeScript"]
    end
    ...
    style Web fill:#61dafb,color:#000,stroke:#0288d1,stroke-width:3px
    style ALB fill:#ff9900,color:#000
    style API1 fill:#512bd4,color:#fff
    style API2 fill:#512bd4,color:#fff
...
graph TB
    ...
    style ALB fill:#ff9900,color:#000
    style WebService fill:#61dafb,color:#000
    style APIService fill:#512bd4,color:#fff
    style WorkerService fill:#512bd4,color:#fff
    style RDS fill:#336791,color:#fff
...
graph TB
    ...
    style CQRS fill:#68217a,color:#fff
    style Entities fill:#239120,color:#fff
    style DbContext fill:#512bd4,color:#fff
...
graph TB
    ...
    style TenantContext fill:#51cf66,color:#000
    style QueryFilter fill:#ffd43b,color:#000
    style DB fill:#336791,color:#fff
```
...
graph TB
    ...
    style Controllers fill:#512bd4,color:#fff
    style Handlers fill:#68217a,color:#fff
    style Entities fill:#239120,color:#fff
...
graph TB
    ...
    style Host fill:#512bd4,color:#fff
    style Timer fill:#ffd43b,color:#000
    style CheckTasks fill:#51cf66,color:#000
    style QueryTasks fill:#336791,color:#fff
